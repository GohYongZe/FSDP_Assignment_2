...
const Signup = () => {
  ...
  const translations = {
    en: {
      ...
      validPhone: 'Please enter a valid Singapore phone number (8 digits, starts with 8 or 9)',
      validPhoneIntl: 'Please enter a valid phone number',
      validNationality: 'Please enter a valid nationality (letters and spaces only)',
      ...
      ageRequirement: 'Your age does not meet the requirements for this account type. Minimum age:',
      ageRequirementMax: 'Your age does not meet the requirements for this account type. Maximum age:',
      ageNotMet: 'Age Requirement Not Met',
      years: 'years',
      selectValidAccount: "Please select a valid account type. 'Select an option' is not allowed",
      ...
      existingAccountMessage: 'This email already has the following account(s):',
      addAnotherAccount: 'Do you want to add another account with the same email?',
      cancel: 'Cancel',
      continue: 'Continue',
      accountCancelled: 'Account creation cancelled. Please use a different email or login with your existing account',
      detailsNotMatch: "The following details don't match your existing account:",
      ensureMatch: 'Please ensure all personal details match your existing account',
      success: 'Success',
    ...
    ms: {
      ...
      validPhone: 'Sila masukkan nombor telefon Singapura yang sah (8 digit, bermula dengan 8 atau 9)',
      validPhoneIntl: 'Sila masukkan nombor telefon yang sah',
      validNationality: 'Sila masukkan kewarganegaraan yang sah (huruf dan ruang sahaja)',
      ...
      ageRequirement: 'Umur anda tidak memenuhi keperluan untuk jenis akaun ini. Umur minimum:',
      ageRequirementMax: 'Umur anda tidak memenuhi keperluan untuk jenis akaun ini. Umur maksimum:',
      ageNotMet: 'Keperluan Umur Tidak Dipenuhi',
      years: 'tahun',
      selectValidAccount: "Sila pilih jenis akaun yang sah. 'Pilih pilihan' tidak dibenarkan",
      ...
      passwordInvalid: 'Kata laluan mesti mengandungi sekurang-kurangnya satu huruf dan satu nombor',
      ...
      addAnotherAccount: 'Adakah anda mahu menambah akaun lain dengan emel yang sama?',
      cancel: 'Batal',
      continue: 'Teruskan',
      accountCancelled: 'Penciptaan akaun dibatalkan. Sila gunakan emel yang berbeza atau log masuk dengan akaun sedia ada anda',
      detailsNotMatch: 'Butiran berikut tidak sepadan dengan akaun sedia ada anda:',
      ensureMatch: 'Sila pastikan semua butiran peribadi sepadan dengan akaun sedia ada anda',
      success: 'Berjaya',
    ...
    ta: {
      ...
      validPhone: 'சரியான சிங்கப்பூர் தொலைபேசி எண்ணை உள்ளிடவும் (8 இலக்கங்கள், 8 அல்லது 9 உடன் தொடங்குகிறது)',
      validPhoneIntl: 'சரியான தொலைபேசி எண்ணை உள்ளிடவும்',
      validNationality: 'சரியான தேசியத்தை உள்ளிடவும் (எழுத்துக்கள் மற்றும் இடைவெளிகள் மட்டுமே)',
      ...
      ageRequirement: 'உங்கள் வயது இந்த கணக்கு வகைக்கான தேவைகளை பூர்த்தி செய்யவில்லை. குறைந்தபட்ச வயது:',
      ageRequirementMax: 'உங்கள் வயது இந்த கணக்கு வகைக்கான தேவைகளை பூர்த்தி செய்யவில்லை. அதிகபட்ச வயது:',
      ageNotMet: 'வயது தேவை பூர்த்தி செய்யப்படவில்லை',
      years: 'ஆண்டுகள்',
      selectValidAccount: "சரியான கணக்கு வகையைத் தேர்ந்தெடுக்கவும். 'ஒரு விருப்பத்தைத் தேர்ந்தெடுக்கவும்' அனுமதிக்கப்படவில்லை",
      ...
      passwordInvalid: 'கடவுச்சொல் குறைந்தது ஒரு எழுத்து மற்றும் ஒரு எண்ணைக் கொண்டிருக்க வேண்டும்',
      invalidPassword: 'தவறான கடவுச்சொல்',
      existingAccountFound: 'ஏற்கனவே உள்ள கணக்கு கண்டுபிடிக்கப்பட்டது',
      existingAccountMessage: 'இந்த மின்னஞ்சலில் ஏற்கனவே பின்வரும் கணக்குகள் உள்ளன:',
      addAnotherAccount: 'அதே மின்னஞ்சலுடன் மற்றொரு கணக்கைச் சேர்க்க விரும்புகிறீர்களா?',
      cancel: 'ரத்து',
      continue: 'தொடர',
      accountCancelled: 'கணக்கு உருவாக்கம் ரத்து செய்யப்பட்டது. வேறு மின்னஞ்சலைப் பயன்படுத்தவும் அல்லது உங்கள் ஏற்கனவே உள்ள கணக்கில் உள்நுழையவும்',
      detailsNotMatch: 'பின்வரும் விவரங்கள் உங்கள் ஏற்கனவே உள்ள கணக்குடன் பொருந்தவில்லை:',
      ensureMatch: 'அனைத்து தனிப்பட்ட விவரங்களும் உங்கள் ஏற்கனவே உள்ள கணக்குடன் பொருந்துவதை உறுதிசெய்யவும்',
      success: 'வெற்றி',
    ...
    hi: {
      ...
      validPhone: 'कृपया एक वैध सिंगापुर फ़ोन नंबर दर्ज करें (8 अंक, 8 या 9 से शुरू)',
      validPhoneIntl: 'कृपया एक वैध फ़ोन नंबर दर्ज करें',
      validNationality: 'कृपया एक वैध राष्ट्रीयता दर्ज करें (केवल अक्षर और रिक्त स्थान)',
      ...
      ageRequirement: 'आपकी उम्र इस खाता प्रकार की आवश्यकताओं को पूरा नहीं करती है। न्यूनतम आयु:',
      ageRequirementMax: 'आपकी उम्र इस खाता प्रकार की आवश्यकताओं को पूरा नहीं करती है। अधिकतम आयु:',
      ageNotMet: 'आयु आवश्यकता पूरी नहीं हुई',
      years: 'वर्ष',
      selectValidAccount: "कृपया एक वैध खाता प्रकार चुनें। 'एक विकल्प चुनें' की अनुमति नहीं है",
      validationError: 'सत्यापन त्रुटि',
      passwordShort: 'पासवर्ड कम से कम 8 वर्ण लंबा होना चाहिए',
      passwordTooShort: 'पासवर्ड बहुत छोटा',
      passwordInvalid: 'पासवर्ड में कम से कम एक अक्षर और एक संख्या होनी चाहिए',
      ...
      cancel: 'रद्द करें',
      continue: 'जारी रखें',
      accountCancelled: 'खाता निर्माण रद्द कर दिया गया। कृपया एक अलग ईमेल का उपयोग करें या अपने मौजूदा खाते में लॉग इन करें',
      detailsNotMatch: 'निम्नलिखित विवरण आपके मौजूदा खाते से मेल नहीं खाते:',
      ensureMatch: 'कृपया सुनिश्चित करें कि सभी व्यक्तिगत विवरण आपके मौजूदा खाते से मेल खाते हैं',
      success: 'सफलता',
    ...
    ja: {
      ...
      invalidEmail: '無効なメール',
      validPhone: '有効なシンガポールの電話番号を入力してください（8桁、8または9で始まる）',
      ...
      ageRequirementMax: 'このアカウントタイプの要件を満たしていません。最大年齢:',
      ageNotMet: '年齢要件が満たされていません',
      years: '歳',
      selectValidAccount: "有効なアカウントタイプを選択してください。'オプションを選択' は許可されていません",
      validationError: '検証エラー',
      passwordShort: 'パスワードは8文字以上である必要があります',
      passwordTooShort: 'パスワードが短すぎます',
      passwordInvalid: 'パスワードには少なくとも1つの文字と1つの数字が含まれている必要があります',
      ...
      cancel: 'キャンセル',
      continue: '続ける',
      accountCancelled: 'アカウント作成がキャンセルされました。別のメールを使用するか、既存のアカウントでログインしてください',
      detailsNotMatch: '次の詳細が既存のアカウントと一致しません:',
      ensureMatch: 'すべての個人情報が既存のアカウントと一致することを確認してください',
      success: '成功',
    ...
    ko: {
      ...
      validPhone: '유효한 싱가포르 전화번호를 입력하세요(8자리, 8 또는 9로 시작)',
      ...
      invalidDate: '잘못된 날짜',
      ageRequirement: '귀하의 연령이 이 계정 유형의 요구 사항을 충족하지 않습니다. 최소 연령:',
      ageRequirementMax: '귀하의 연령이 이 계정 유형의 요구 사항을 충족하지 않습니다. 최대 연령:',
      ageNotMet: '연령 요구 사항 미충족',
      years: '세',
      selectValidAccount: "유효한 계정 유형을 선택하세요. '옵션 선택'은 허용되지 않습니다",
      validationError: '검증 오류',
      passwordShort: '비밀번호는 최소 8자 이상이어야 합니다',
      passwordTooShort: '비밀번호가 너무 짧습니다',
      passwordInvalid: '비밀번호는 최소한 하나의 문자와 하나의 숫자를 포함해야 합니다',
      ...
      cancel: '취소',
      continue: '계속',
      accountCancelled: '계정 생성이 취소되었습니다. 다른 이메일을 사용하거나 기존 계정으로 로그인하세요',
    ...
    es: {
      ...
      nationalityPlaceholder: 'ej. Singapurense',
      ...
      validPhone: 'Por favor, ingrese un número de teléfono de Singapur válido (8 dígitos, comienza con 8 o 9)',
      validPhoneIntl: 'Por favor, ingrese un número de teléfono válido',
      validNationality: 'Por favor, ingrese una nacionalidad válida (solo letras y espacios)',
      nricRequired: 'Se requiere NRIC para cuentas locales',
      validNRIC: 'Por favor, ingrese un NRIC válido (ej., S1234567A)',
      invalidNRIC: 'NRIC no válido',
      dobPast: 'La fecha de nacimiento debe estar en el pasado',
      invalidDate: 'Fecha no válida',
      ageRequirement: 'Su edad no cumple con los requisitos para este tipo de cuenta. Edad mínima:',
      ageRequirementMax: 'Su edad no cumple con los requisitos para este tipo de cuenta. Edad máxima:',
      ageNotMet: 'Requisito de edad no cumplido',
      years: 'años',
      selectValidAccount: "Por favor, seleccione un tipo de cuenta válido. No se permite 'Seleccione una opción'",
      ...
      existingAccountFound: 'Se encontró una cuenta existente',
      existingAccountMessage: 'Este correo electrónico ya tiene las siguientes cuentas:',
      addAnotherAccount: '¿Desea agregar otra cuenta con el mismo correo electrónico?',
      cancel: 'Cancelar',
      continue: 'Continuar',
      accountCancelled: 'Creación de cuenta cancelada. Por favor, use un correo electrónico diferente o inicie sesión con su cuenta existente',
      detailsNotMatch: 'Los siguientes detalles no coinciden con su cuenta existente:',
      ensureMatch: 'Por favor, asegúrese de que todos los datos personales coincidan con su cuenta existente',
      success: 'Éxito',
    ...
    fr: {
      ...
      validPhone: 'Veuillez entrer un numéro de téléphone de Singapour valide (8 chiffres, commence par 8 ou 9)',
      validPhoneIntl: 'Veuillez entrer un numéro de téléphone valide',
      validNationality: 'Veuillez entrer une nationalité valide (lettres et espaces uniquement)',
      ...
      ageRequirement: 'Votre âge ne répond pas aux exigences pour ce type de compte. Âge minimum:',
      ageRequirementMax: 'Votre âge ne répond pas aux exigences pour ce type de compte. Âge maximum:',
      ageNotMet: "Exigence d'âge non satisfaite",
      years: 'ans',
      selectValidAccount: "Veuillez sélectionner un type de compte valide. 'Sélectionnez une option' n'est pas autorisé",
      validationError: 'Erreur de validation',
      passwordShort: 'Le mot de passe doit contenir au moins 8 caractères',
      passwordTooShort: 'Mot de passe trop court',
      passwordInvalid: 'Le mot de passe doit contenir au moins une lettre et un chiffre',
      ...
      addAnotherAccount: 'Voulez-vous ajouter un autre compte avec le même e-mail?',
      cancel: 'Annuler',
      continue: 'Continuer',
      accountCancelled: 'Création de compte annulée. Veuillez utiliser un e-mail différent ou vous connecter avec votre compte existant',
      detailsNotMatch: 'Les détails suivants ne correspondent pas à votre compte existant:',
      ensureMatch: 'Veuillez vous assurer que toutes les informations personnelles correspondent à votre compte existant',
      success: 'Succès',
    ...
    de: {
      ...
      validPhone: 'Bitte geben Sie eine gültige Singapur-Telefonnummer ein (8 Ziffern, beginnt mit 8 oder 9)',
      validPhoneIntl: 'Bitte geben Sie eine gültige Telefonnummer ein',
      validNationality: 'Bitte geben Sie eine gültige Nationalität ein (nur Buchstaben und Leerzeichen)',
      ...
      ageRequirement: 'Ihr Alter erfüllt nicht die Anforderungen für diesen Kontotyp. Mindestalter:',
      ageRequirementMax: 'Ihr Alter erfüllt nicht die Anforderungen für diesen Kontotyp. Höchstalter:',
      ageNotMet: 'Altersanforderung nicht erfüllt',
      years: 'Jahre',
      selectValidAccount: "Bitte wählen Sie einen gültigen Kontotyp aus. 'Option auswählen' ist nicht zulässig",
      validationError: 'Validierungsfehler',
      passwordShort: 'Das Passwort muss mindestens 8 Zeichen lang sein',
      passwordTooShort: 'Passwort zu kurz',
      passwordInvalid: 'Das Passwort muss mindestens einen Buchstaben und eine Zahl enthalten',
      invalidPassword: 'Ungültiges Passwort',
      existingAccountFound: 'Bestehendes Konto gefunden',
      existingAccountMessage: 'Diese E-Mail hat bereits folgende Konten:',
      addAnotherAccount: 'Möchten Sie ein weiteres Konto mit derselben E-Mail hinzufügen?',
      cancel: 'Abbrechen',
      continue: 'Fortfahren',
      accountCancelled: 'Kontoerstellung abgebrochen. Bitte verwenden Sie eine andere E-Mail oder melden Sie sich mit Ihrem bestehenden Konto an',
      detailsNotMatch: 'Die folgenden Details stimmen nicht mit Ihrem bestehenden Konto überein:',
      ensureMatch: 'Bitte stellen Sie sicher, dass alle persönlichen Daten mit Ihrem bestehenden Konto übereinstimmen',
      success: 'Erfolg',
            ...
            },
            {
              ...
              onPress: async () => {
                ...
                if (!detailsMatch.isValid) {
                  setLoading(false);
                  setErrorMessage(`${t.detailsNotMatch}\n${detailsMatch.errors.join('\n')}\n\n${t.ensureMatch}`);
                  return;
                }
  ...
  const createAccount = async (formattedPhone: string, isExistingUser: boolean, existingUserData: any) => {
    try {
      ...
      let successMessage = `${t.accountCreated}\n${t.accountNumber} ${accountNo}\n${t.debitCardNumber} ${formatCardNumber(debitCardNo)}`;
      if (creditCardNo) {
        successMessage += `\n${t.creditCardNumber} ${formatCardNumber(creditCardNo)}`;
      }
        ...
        >
          ...
          <View style={styles.formGroup}>
            <Text style={styles.label}>
              {residency === 'foreign' ? t.singaporeAddress : t.registeredAddress}
            </Text>
            <TextInput
          ...
          <View style={styles.formGroup}>
            <Text style={styles.label}>
              {residency === 'foreign' ? t.nationality : t.nationalityCitizenship}
            </Text>
            <TextInput
              style={styles.input}

...
export default function GiveSuccessScreen() {
  ...
  const recipientName = params.recipientName as string; // whom i requested from
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 px-6 pt-6 items-center">
          ...
          <Text className="text-3xl font-bold text-gray-900 mb-8">{amount} SGD requested</Text>

          <View className="w-full space-y-6">
              <View>
                  <Text className="text-gray-500 text-sm font-bold uppercase mb-1">Requested From</Text>
          ...
          <View className="w-full pb-8">
              ...
              >
                  <Text className="text-white font-bold text-lg">Make Another Request</Text>
              </TouchableOpacity>

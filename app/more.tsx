...
const More = ({ navigation }: MoreProps) => {
  ...
  const translations: Record<string, any> = {
    ...
    hi: {
      ...
      resetCardPIN: "कार्ड PIN रीसेट करें",
...
>>>>>>> 02556a4fb64f60907d36da3a683d3985561433ab
  };
  ...
  const allMenuItems: MenuItem[] = [
    ...
    // Card Services
    {
      ...
      category: t.cardServices,
    },
    {
      id: "4",
      icon: "sync-alt",
      label: t.resetCardPIN,
      category: t.cardServices,
    },
    {
      id: "5",
      icon: "lock",
      label: t.lockUnlockCard,
      category: t.cardServices,
    },
    ...
    // Accounts
    {
      ...
      label: t.moneyLock,
      category: t.accountsCategory,
    },
    {
      id: "8",
      icon: "file-alt",
      label: t.chequeServices,
      category: t.accountsCategory,
    },
    ...
    },
    {
      id: "11",
      icon: "credit-card",
      label: t.topUpPrepaid,
      category: t.paymentsTransfers,
    },
    {
      id: "12",
      icon: "qrcode",
      label: t.qrCashWithdrawal,
      category: t.paymentsTransfers,
    },
    ...
    { id: "14", icon: "lock", label: t.changePassword, category: t.settings },
    {
      id: "15",
      icon: "sign-in-alt",
      label: t.manageLoginToken,
      category: t.settings,
    },
    {
      id: "16",
      icon: "text-height",
      label: t.textSizeDisplay,
      category: t.settings,
    },
    {
      id: "17",

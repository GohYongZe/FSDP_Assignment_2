...
const Landing = () => {
  ...
  const translations = {
    en: {
      ...
      securityAdvisory: 'Security advisory: Be aware of e-commerce scams. Do not click links or scan QR codes to make/collect payments - if an offer seems',
    ...
    zh: {
      ...
      signupButton: '注册为新客户',
      loginButton: '现有客户登录',
      securityAdvisory: '安全提示：警惕电子商务诈骗。不要点击链接或扫描二维码进行付款/收款 - 如果优惠看起来',
    ...
    ms: {
      ...
      securityAdvisory: 'Nasihat keselamatan: Berhati-hati dengan penipuan e-dagang. Jangan klik pautan atau imbas kod QR untuk membuat/mengumpul pembayaran - jika tawaran kelihatan',
      goodToBeTrueHighlight: 'terlalu bagus untuk menjadi kenyataan, ia mungkin memang begitu.',
    ...
    ta: {
      ...
      securityAdvisory: 'பாதுகாப்பு ஆலோசனை: மின்-வர்த்தக மோசடிகள் குறித்து எச்சரிக்கையாக இருங்கள். இணைப்புகளைக் கிளிக் செய்யாதீர்கள் அல்லது QR குறியீடுகளை ஸ்கேன் செய்யாதீர்கள் - ஒரு சலுகை',
      goodToBeTrueHighlight: 'உண்மையாக இருக்க மிகவும் நன்றாகத் தோன்றினால், அது அப்படித்தான் இருக்கலாம்.',
    ...
    hi: {
      ...
      securityAdvisory: 'सुरक्षा सलाह: ई-कॉमर्स घोटालों से सावधान रहें। भुगतान करने/एकत्र करने के लिए लिंक पर क्लिक न करें या QR कोड स्कैन न करें - यदि कोई ऑफ़र',
      goodToBeTrueHighlight: 'सच होने के लिए बहुत अच्छा लगता है, तो यह संभवतः वही है।',
      learnMore: 'और जानें',
    ...
    ja: {
      ...
      securityAdvisory: 'セキュリティ勧告：Eコマース詐欺にご注意ください。リンクをクリックしたり、QRコードをスキャンして支払いを行ったり収集したりしないでください - 申し出が',
      goodToBeTrueHighlight: '本当であるには良すぎるように見える場合、それはおそらくそうです。',
      learnMore: 'もっと詳しく知る',
    ...
    ko: {
      ...
      securityAdvisory: '보안 권고: 전자 상거래 사기에 주의하십시오. 링크를 클릭하거나 QR 코드를 스캔하여 지불하거나 수집하지 마십시오 - 제안이',
      goodToBeTrueHighlight: '사실이기에 너무 좋아 보인다면 그럴 가능성이 높습니다.',
      learnMore: '자세히 알아보기',
    ...
    es: {
      ...
      securityAdvisory: 'Aviso de seguridad: Tenga cuidado con las estafas de comercio electrónico. No haga clic en enlaces ni escanee códigos QR para realizar/recopilar pagos - si una oferta parece',
      goodToBeTrueHighlight: 'demasiado buena para ser verdad, probablemente lo sea.',
    ...
    fr: {
      ...
      securityAdvisory: 'Avis de sécurité : Méfiez-vous des escroqueries de commerce électronique. Ne cliquez pas sur les liens ou ne scannez pas les codes QR pour effectuer/collecter des paiements - si une offre semble',
      goodToBeTrueHighlight: 'trop belle pour être vraie, elle l\'est probablement.',
    ...
    de: {
      ...
      securityAdvisory: 'Sicherheitshinweis: Seien Sie sich E-Commerce-Betrug bewusst. Klicken Sie nicht auf Links oder scannen Sie QR-Codes, um Zahlungen zu tätigen/zu sammeln - wenn ein Angebot',
      goodToBeTrueHighlight: 'zu gut aussieht, um wahr zu sein, ist es das wahrscheinlich auch.',
  ...
  const handleLanguageSelect = async (language: typeof languages[0]) => {
    ...
    Alert.alert(translations[language.code as keyof typeof translations].languageChanged, `${translations[language.code as keyof typeof translations].languageSwitched} ${language.label}`);
  };

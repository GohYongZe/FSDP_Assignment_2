  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      content: "S$150.00 transferred successfully to Alex B.",
      icon: "exchange-alt",
      time: "5 mins ago",
      read: false,
    },
    {
      ...
      content: "Your new OCBC Credit Card has been approved and shipped.",
      icon: "credit-card",
      time: "1 hour ago",
      read: false,
    },
    {
      ...
      content: "Earn 5% cashback on groceries this weekend!",
      icon: "gift",
      time: "Yesterday",
      read: true,
    },
    {
      ...
      content:
        "Scheduled maintenance tonight at 11 PM. Services may be briefly impacted.",
      icon: "wrench",
      time: "2 days ago",
      read: true,
    },
    {
      ...
      content: "Your monthly e-Statement for October is now available.",
      icon: "file-pdf",
      time: "1 week ago",
      read: true,
    },

...
const AccountDetailsScreen = ({ navigation }: { navigation: NavigationProp<any> }) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <TouchableOpacity style={styles.toggleButton} onPress={toggleAdvanced}>
          <Text style={styles.toggleButtonText}>
            {showAdvanced ? 'Hide Full History and Management' : 'View Full History and Management'}
          </Text>
          <Icon 
        ...
        {showAdvanced && (
          <View style={styles.advancedFeatures}>
            ...
            <TouchableOpacity style={styles.actionButton}>
              <Text style={styles.actionButtonText}>Change Account Nickname</Text>
            </TouchableOpacity>
            
            <Text style={styles.placeholderText}>[Many older transactions would be listed here]</Text>
          </View>
        )}
      </ScrollView>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem}>
          <Icon name="home" size={20} color="#da291c" />
          <Text style={[styles.navText, { color: '#da291c' }]}>Home</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
...
const styles = StyleSheet.create({
  ...
  advancedTitle: { fontSize: 17, fontWeight: '700', color: '#005eb8', marginBottom: 15 },
  infoBox: {
  ...
  placeholderText: { textAlign: 'center', color: '#888', fontStyle: 'italic', marginTop: 10 },
  bottomNav: {
    position: 'absolute',
    bottom: 0,
    flexDirection: 'row',
